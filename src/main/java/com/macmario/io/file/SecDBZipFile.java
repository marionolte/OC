...
public class SecDBZipFile extends Version{
    ...
    public static void main(String[] args) {
        ...
        SecDBZipFile sdb;
        if ( args.length > 0 ){                
                sdb=new SecDBZipFile(new ReadFile(args[0]));
                sdb.log(1,"SecDBFile:main - "+args[0]);
        } else {
                
                sdb=new SecDBZipFile(ReadFile.getTempFile());
