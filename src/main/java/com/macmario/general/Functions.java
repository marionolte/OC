...
import static com.macmario.general.Version.getBetaVersion;
import static com.macmario.general.Version.getVersion;
import static com.macmario.general.Version.isBeta;
import static com.macmario.general.Version.mhservice;
import static com.macmario.general.Version.prodauthor;
...
public class Functions {
    ...
    private static int patchVersion=8;
    private static int fixedVersion=0;
    private static int   libVersion=0;
    ...
    static {
       ...
       TEMPDIR     = System.getProperty("java.io.tmpdir");
        ...
        fixedVersion=Version.fixedVersion;
    ...
    public boolean isAscii(String s) {
        ...
        return isAscii(s.getBytes());
    }
    public boolean isAscii(byte[] by) {
        if ( by.length > 0 ) {
