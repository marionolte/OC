...
public class ChannelManager implements MessageHandler
{
	...
	/* This is used to work around broken servers, issue #2870066 */
	...
	public void msgChannelSuccess(byte[] msg, int msglen) throws IOException
	{
		...
		/*
		 * This is a compatability fix, for servers which provide the server ID rather than the recipient
		 * ID in this message.
		 */
		if (c == null)
		{
			...
			if (c != null)
				log.log(40, "SSH_MSG_CHANNEL_SUCCESS has sender channel number; adjusting");
		}
	...
	public void msgChannelFailure(byte[] msg, int msglen) throws IOException
	{
		...
		if (c == null)
		{
			c = getChannelByRemoteID(id);
			if (c != null)
				log.log(40, "SSH_MSG_CHANNEL_FAILURE has sender channel number; adjusting");
		}
