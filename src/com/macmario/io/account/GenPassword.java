...
public class GenPassword {
    ...
    public static int MIN_STRONG_LENGTH = 12;
    ...
    public static String getPassword(int length, PasswordTyp typ) {
        return getNext(length, typ);
    }
    
    public static String getPassword(PasswordTyp typ) {
        return getNext(MIN_LENGTH, typ);
    }
    ...
    public static void main(String[] args){
		...
		if ( args[i].matches("-l") ) {  GenPassword.MIN_LENGTH=Integer.parseInt(args[++i]); } 
	} 
	for(int i=0; i<GenPassword.MIN_LENGTH;i++) 
