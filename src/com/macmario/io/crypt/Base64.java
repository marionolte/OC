 ...
 */
public class Base64 extends Version {
    ...
    public static byte[] decodeBase64(String base64String) { return decodeBase64(  base64String.getBytes() ); }
     ...
     *                          of type byte[]
     */
    static public Object encode(Object pObject) {
        if (!(pObject instanceof byte[])) {
     ...
     */
    static public byte[] encode(byte[] pArray) {
    ...
    public static void main(String[] args) {
        ...
        for (int i=0; i< args.length; i++ ) {
            ...
            StringBuilder sb= new StringBuilder();
                          sb.append("DECODE:");
            byte[] b = decodeBase64( args[i].getBytes() );
            for (int j=0; j<b.length; j++) { sb.append( b[j] ); }
                          sb.append(":\nENCODE:");
                   b = encodeBase64( args[i].getBytes() );
            for (int j=0; j<b.length; j++) { sb.append( b[j] ); }
